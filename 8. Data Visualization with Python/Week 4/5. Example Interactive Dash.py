...
@app.callback(
    ...
    # We set up that the input that triggers change when updated is
    # the html input whose id is input-year when its property value is
    # modified we will call this function, execute it and replace the
    # interactive graph bar-plot with the one returned in this function
