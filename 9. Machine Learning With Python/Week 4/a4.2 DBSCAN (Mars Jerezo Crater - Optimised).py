...
clust_subset_size = min(800_000, n_points)  # for DBSCAN itself
...
k: float = 3.2
print("7. Creating the DBSCAN algorithm with k={0}".format(k))
# Apply K-Means
print("7.1 Multiplier k = {0}".format(k))
eps_m = float(eps0_m * k)
print("7.2 Building the DBSCAN object")
dbscan_mod = DBSCAN(eps=eps_m, min_samples=10, metric='euclidean',
...
out_png = r".\mars_jerezo_dbscan.png"
...
In the end, the solution was to sample our variable and use DBSCAN with
