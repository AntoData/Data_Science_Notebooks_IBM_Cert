...
to create a proportional sample of the variables. Then, we will use that
 sample to train a HDBSCAN algorithm and use its labels as the seeds of 
...
def colour_scale_array(start_color: (int, int, int),
    ...
    for j in range(steps):
        t: float = j / (steps - 1)  # fraction from 0 to 1
...
print("9. Building the HDBSCAN model")
...
out_png = r".\HDBSCAN_mercury_elevation.png"
