...
train a Kmeans  algorithm and classify the different areas of the Pluto
 ...
 that sample to train a DBSCAN algorith. We will use the result of that
...
# Set custom tick labels
out_png = r".\DBSCAN_pluto_elevation.png"
...
"""
CONCLUSION: DBSCAN does not work particularly well with 1-D continuous
variables. With millions of points packed into a continuous band of 
values, DBSCAN sees one huge, contiguous “dense” region ⇒ one giant 
cluster.
"""