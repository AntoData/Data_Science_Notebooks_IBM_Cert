...
# 4. Let's build the decision tree with criterion entropy and iterate
...
for max_depth_ in range(4, 21):
    ...
    # 5. Let's use cross_val_score to get different accuracy scores
    acc_scores: [float] = cross_val_score(decision_tree_meteor, df_x_scl,
                                          df_y, scoring="accuracy", cv=5)

    # 6. Let's get the mean accuracy score
