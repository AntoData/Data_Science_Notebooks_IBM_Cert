...
# 4. Let's build the decision tree whose criterion is entropy and
...
for max_depth_ in range(4, 21):
    ...
    # 4. Let's use cross_val_score to get several accuracy scores
    acc_scores: [float] = cross_val_score(decision_tree_earthquakes,
                                          df_scl, df_y, scoring="accuracy",
                                          cv=5)
